...
RMK202_snpeff_eggnog_repeats_core_uniuqes_final_reduce <- RMK202_snpeff_eggnog_repeats_core %>% select(c("typeName","finalName","Preferred_name","eggNOG free text description","EC","KEGG_ko","core")) %>% mutate(gene=typeName) %>% select(-typeName)%>% distinct()

# RMK202_snpeff_eggnog_repeats_core$typeName
...
write.csv(RMK202_snpeff_eggnog_repeats_core_uniuqes_final_reduce,file="~/Desktop/presenations/my_presentations/20191007_groupmeeting/figures/RMK202_snpeff_eggnog_repeats_core_dNdS_uniqueGenes_subset_02.txt")
